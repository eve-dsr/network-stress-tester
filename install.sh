...
if [ -f "/etc/debian_version" ]; then
        ...
        echo "[i] We will now download Network Stress Tester..."
        sudo git clone https://github.com/eve-dsr/network-stress-tester.git > /dev/null 2>&1 || echo "[!] Could not download Network Stress Tester."
        cd network-stress-tester > /dev/null 2>&1
        ...
        echo "[i] We will now install Network Stress Tester..."
        sudo bash ./install_to_bin.sh || echo "[!] Could not install Network Stress Tester."
        ...
        git clone https://github.com/eve-dsr/network-stress-tester.git > /dev/null 2>&1 || echo "[!] Please install git"
